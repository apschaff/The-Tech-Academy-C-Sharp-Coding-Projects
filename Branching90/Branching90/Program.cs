...
namespace Branching90
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    Console.WriteLine("It is exactly room temperatre.");
            //}
            ...
            //else
            //{
            //    Console.WriteLine("Umm... something went wrong.");
            //}
            ...
            //// this is a one line if else statement turnery operator (if a == b ?(then) c :(else) d)
